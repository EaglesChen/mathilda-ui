export declare const ElSegmented: import("element-plus/es/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            options: import("element-plus/es/components/segmented/src/types").Option[];
            ...
            options: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/components/segmented/src/types").Option[]) | (() => import("element-plus/es/components/segmented/src/types").Option[]) | ((new (...args: any[]) => import("element-plus/es/components/segmented/src/types").Option[]) | (() => import("element-plus/es/components/segmented/src/types").Option[]))[], unknown, unknown, () => never[], boolean>;
    ...
    $slots: {
        default?(_: {
            item: import("element-plus/es/components/segmented/src/types").Option;
        }): any;
    };
})> & Record<string, any>;
export default ElSegmented;
export * from 'element-plus/es/components/segmented/src/segmented';
