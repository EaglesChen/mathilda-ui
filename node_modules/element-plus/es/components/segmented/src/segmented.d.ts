import type { Option } from 'element-plus/es/components/segmented/src/types';
import type { ExtractPropTypes } from 'vue';
import type Segmented from 'element-plus/es/components/segmented/src/segmented.vue';
