...
import type { SliderMarkerProps } from 'element-plus/es/components/slider/src/marker';
import type Slider from 'element-plus/es/components/slider/src/slider.vue';
