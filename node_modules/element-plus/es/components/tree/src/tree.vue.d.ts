...
import type { TreeComponentProps, TreeData, TreeKey, TreeNodeData } from 'element-plus/es/components/tree/src/tree.type';
declare const _default: import("vue").DefineComponent<{
    ...
    store: import("vue").Ref<{
        currentNode: {
            ...
            remove: () => void;
            insertChild: (child?: import("element-plus/es/components/tree/src/tree.type").FakeNode | Node, index?: number, batch?: boolean) => void;
            insertBefore: (child: import("element-plus/es/components/tree/src/tree.type").FakeNode | Node, ref: Node) => void;
            insertAfter: (child: import("element-plus/es/components/tree/src/tree.type").FakeNode | Node, ref: Node) => void;
            removeChild: (child: Node) => void;
            removeChildByData: (data: TreeNodeData) => void;
            expand: (callback?: () => void, expandParent?: boolean) => void;
            doCreateChildren: (array: TreeNodeData[], defaultProps?: import("element-plus/es/components/tree/src/tree.type").TreeNodeLoadedDefaultProps) => void;
            collapse: () => void;
