...
import type { DefaultRow, Table } from 'element-plus/es/components/table/src/table/defaults';
import type { TableOverflowTooltipFormatter, TableOverflowTooltipOptions } from 'element-plus/es/components/table/src/util';
type CI<T> = {
