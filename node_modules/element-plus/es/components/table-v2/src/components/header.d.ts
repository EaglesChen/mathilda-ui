...
import type { TableV2HeaderProps } from 'element-plus/es/components/table-v2/src/header';
import type { UseColumnsReturn } from 'element-plus/es/components/table-v2/src/composables/use-columns';
