...
import type { ColumnCellsType } from 'element-plus/es/components/table-v2/src/types';
import type { TableV2HeaderRowProps } from 'element-plus/es/components/table-v2/src/header-row';
