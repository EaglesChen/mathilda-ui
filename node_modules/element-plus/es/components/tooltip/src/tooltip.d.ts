import type Tooltip from 'element-plus/es/components/tooltip/src/tooltip.vue';
...
export declare const useTooltipProps: {
    ...
    trigger: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => "click" | "contextmenu" | "focus" | "hover" | import("element-plus/es/components/tooltip/src/trigger").TooltipTriggerType[]) | (() => import("element-plus/es/utils").Arrayable<import("element-plus/es/components/tooltip/src/trigger").TooltipTriggerType>) | ((new (...args: any[]) => "click" | "contextmenu" | "focus" | "hover" | import("element-plus/es/components/tooltip/src/trigger").TooltipTriggerType[]) | (() => import("element-plus/es/utils").Arrayable<import("element-plus/es/components/tooltip/src/trigger").TooltipTriggerType>))[], unknown, unknown, "hover", boolean>;
