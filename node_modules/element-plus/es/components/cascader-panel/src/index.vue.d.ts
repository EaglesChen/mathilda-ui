...
import type { CascaderNodeValue, CascaderOption, CascaderValue, RenderLabel } from 'element-plus/es/components/cascader-panel/src/node';
declare const _default: import("vue").DefineComponent<{
    ...
    modelValue: {
        readonly type: PropType<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string | number | import("element-plus/es/components/cascader-panel/src/node").CascaderNodePathValue | (CascaderNodeValue | import("element-plus/es/components/cascader-panel/src/node").CascaderNodePathValue)[]) | (() => CascaderValue) | ((new (...args: any[]) => string | number | import("element-plus/es/components/cascader-panel/src/node").CascaderNodePathValue | (CascaderNodeValue | import("element-plus/es/components/cascader-panel/src/node").CascaderNodePathValue)[]) | (() => CascaderValue))[], unknown, unknown>>;
    ...
    props: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/components/cascader-panel/src/node").CascaderProps) | (() => import("element-plus/es/components/cascader-panel/src/node").CascaderProps) | ((new (...args: any[]) => import("element-plus/es/components/cascader-panel/src/node").CascaderProps) | (() => import("element-plus/es/components/cascader-panel/src/node").CascaderProps))[], unknown, unknown, () => import("element-plus/es/components/cascader-panel/src/node").CascaderProps, boolean>;
}, {
    ns: {
    ...
    menus: import("vue").Ref<{
        ...
        readonly config: {
            expandTrigger: import("element-plus/es/components/cascader-panel/src/node").ExpandTrigger;
            multiple: boolean;
    ...
    border: boolean;
    props: import("element-plus/es/components/cascader-panel/src/node").CascaderProps;
