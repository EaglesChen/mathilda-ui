...
import { BACKWARD, FORWARD } from 'element-plus/es/components/virtual-list/src/defaults';
import type { CSSProperties, Ref, StyleValue, UnwrapRef, VNode } from 'vue';
import type { Alignment, GridConstructorProps, GridScrollOptions } from 'element-plus/es/components/virtual-list/src/types';
import type { VirtualizedGridProps } from 'element-plus/es/components/virtual-list/src/props';
declare const createGrid: ({ name, clearCache, getColumnPosition, getColumnStartIndexForOffset, getColumnStopIndexForStartIndex, getEstimatedTotalHeight, getEstimatedTotalWidth, getColumnOffset, getRowOffset, getRowPosition, getRowStartIndexForOffset, getRowStopIndexForStartIndex, initCache, injectToInstance, validateProps, }: GridConstructorProps<VirtualizedGridProps>) => import("vue").DefineComponent<{
    ...
    readonly columnWidth: {
        readonly type: import("vue").PropType<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => number | import("element-plus/es/components/virtual-list/src/types").ItemSize) | (() => number | import("element-plus/es/components/virtual-list/src/types").ItemSize) | ((new (...args: any[]) => number | import("element-plus/es/components/virtual-list/src/types").ItemSize) | (() => number | import("element-plus/es/components/virtual-list/src/types").ItemSize))[], never, never>>;
        readonly required: true;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
    ...
    readonly itemKey: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter) | (() => import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter) | {
        (): import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter;
        new (): any;
        readonly prototype: any;
    } | ((new (...args: any[]) => import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter) | (() => import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter) | {
        (): import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter;
        new (): any;
        readonly prototype: any;
    ...
    readonly itemKey: import("element-plus/es/components/virtual-list/src/types").GridItemKeyGetter;
