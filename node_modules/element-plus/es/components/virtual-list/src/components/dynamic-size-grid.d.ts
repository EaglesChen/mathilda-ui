import type { GridInstance } from 'element-plus/es/components/virtual-list/src/builders/build-grid';
import type { ItemSize } from 'element-plus/es/components/virtual-list/src/types';
type Indices = {
    columnIndex?: number;
    rowIndex?: number;
};
