...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly prop: {
        readonly type: import("vue").PropType<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string | string[]) | (() => import("element-plus/es/components/form/src/form-item").FormItemProp) | ((new (...args: any[]) => string | string[]) | (() => import("element-plus/es/components/form/src/form-item").FormItemProp))[], unknown, unknown>>;
