...
import type { FormItemContext, FormValidateCallback, FormValidationResult } from 'element-plus/es/components/form/src/types';
...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly rules: {
        readonly type: import("vue").PropType<Partial<Record<string, Arrayable<import("element-plus/es/components/form/src/types").FormItemRule>>>>;
