import type { ProgressColor } from 'element-plus/es/components/progress/src/progress';
...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly color: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]) | (() => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]) | ((new (...args: any[]) => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]) | (() => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]))[], unknown, unknown, "", boolean>;
    readonly striped: BooleanConstructor;
    readonly stripedFlow: BooleanConstructor;
    readonly format: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/components/progress/src/progress").ProgressFn) | (() => import("element-plus/es/components/progress/src/progress").ProgressFn) | {
        (): import("element-plus/es/components/progress/src/progress").ProgressFn;
        new (): any;
        readonly prototype: any;
    } | ((new (...args: any[]) => import("element-plus/es/components/progress/src/progress").ProgressFn) | (() => import("element-plus/es/components/progress/src/progress").ProgressFn) | {
        (): import("element-plus/es/components/progress/src/progress").ProgressFn;
        new (): any;
        readonly prototype: any;
    ...
    readonly color: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]) | (() => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]) | ((new (...args: any[]) => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]) | (() => string | import("element-plus/es/components/progress/src/progress").ProgressFn | ProgressColor[]))[], unknown, unknown>;
    ...
    readonly format: import("element-plus/es/components/progress/src/progress").ProgressFn;
