...
import type { DateModelType, DayOrDays, SingleOrRange } from 'element-plus/es/components/time-picker/src/common/props';
...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly modelValue: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => string | number | string[] | Date | [DateModelType, DateModelType]) | (() => import("element-plus/es/components/time-picker/src/common/props").ModelValueType) | ((new (...args: any[]) => string | number | string[] | Date | [DateModelType, DateModelType]) | (() => import("element-plus/es/components/time-picker/src/common/props").ModelValueType))[], unknown, unknown, "", boolean>;
    ...
    readonly modelValue: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string | number | string[] | Date | [DateModelType, DateModelType]) | (() => import("element-plus/es/components/time-picker/src/common/props").ModelValueType) | ((new (...args: any[]) => string | number | string[] | Date | [DateModelType, DateModelType]) | (() => import("element-plus/es/components/time-picker/src/common/props").ModelValueType))[], unknown, unknown>;
