import type { AutocompleteData } from 'element-plus/es/components/autocomplete/src/autocomplete';
...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly fetchSuggestions: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => AutocompleteData | ((queryString: string, cb: import("element-plus/es/components/autocomplete/src/autocomplete").AutocompleteFetchSuggestionsCallback) => import("element-plus/es/utils").Awaitable<AutocompleteData> | void)) | (() => import("element-plus/es/components/autocomplete/src/autocomplete").AutocompleteFetchSuggestions) | ((new (...args: any[]) => AutocompleteData | ((queryString: string, cb: import("element-plus/es/components/autocomplete/src/autocomplete").AutocompleteFetchSuggestionsCallback) => import("element-plus/es/utils").Awaitable<AutocompleteData> | void)) | (() => import("element-plus/es/components/autocomplete/src/autocomplete").AutocompleteFetchSuggestions))[], unknown, unknown, () => void, boolean>;
    ...
    readonly fetchSuggestions: import("element-plus/es/components/autocomplete/src/autocomplete").AutocompleteFetchSuggestions;
