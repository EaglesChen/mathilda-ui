import type { UploadFile, UploadRawFile } from 'element-plus/es/components/upload/src/upload';
...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly onProgress: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void) | (() => (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void) | {
        (): (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void;
        new (): any;
        readonly prototype: any;
    } | ((new (...args: any[]) => (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void) | (() => (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void) | {
        (): (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void;
        new (): any;
        readonly prototype: any;
    })[], unknown, unknown, () => void, boolean>;
    ...
    readonly data: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/utils").Mutable<Record<string, any>> | Promise<import("element-plus/es/utils").Mutable<Record<string, any>>> | ((rawFile: UploadRawFile) => import("element-plus/es/utils").Awaitable<import("element-plus/es/components/upload/src/upload").UploadData>)) | (() => import("element-plus/es/utils").Awaitable<import("element-plus/es/utils").Mutable<Record<string, any>>> | ((rawFile: UploadRawFile) => import("element-plus/es/utils").Awaitable<import("element-plus/es/components/upload/src/upload").UploadData>)) | ((new (...args: any[]) => import("element-plus/es/utils").Mutable<Record<string, any>> | Promise<import("element-plus/es/utils").Mutable<Record<string, any>>> | ((rawFile: UploadRawFile) => import("element-plus/es/utils").Awaitable<import("element-plus/es/components/upload/src/upload").UploadData>)) | (() => import("element-plus/es/utils").Awaitable<import("element-plus/es/utils").Mutable<Record<string, any>>> | ((rawFile: UploadRawFile) => import("element-plus/es/utils").Awaitable<import("element-plus/es/components/upload/src/upload").UploadData>)))[], unknown, unknown, () => import("element-plus/es/utils").Mutable<{}>, boolean>;
    ...
    readonly onProgress: (evt: import("element-plus/es/components/upload/src/upload").UploadProgressEvent, rawFile: UploadRawFile) => void;
