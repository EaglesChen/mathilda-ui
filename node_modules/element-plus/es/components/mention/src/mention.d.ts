...
import type Mention from 'element-plus/es/components/mention/src/mention.vue';
...
export type { MentionOption } from 'element-plus/es/components/mention/src/types';
