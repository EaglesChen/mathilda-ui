...
import { FullIconCustomisations } from '@iconify/utils/lib/customisations/defaults.js';
...
export type { AutoInstall, CustomCollections, CustomIconLoader, ExternalPkgName, IconCustomizations, IconCustomizer, IconifyLoaderOptions, InlineCollection, UniversalIconLoader };
